...
snakemake <- Snakemake(
    ...
    output = list('output/heatmap/sample_virus_heatmap.pdf', "pdf" = 'output/heatmap/sample_virus_heatmap.pdf'),
...
heatmaply(select(abun_wide, -taxon_name),
          ...
          col_side_colors = metadata_df_match[-1],showticklabels=FALSE,
