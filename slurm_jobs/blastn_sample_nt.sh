...
nt="/shared/bank/nt/current/flat/nt"
datadir="${workdir}data/blast_nt/"
...
n=100
query_fa="${workdir}/data/blast_db/testquerydata/ERR6913147.flash.extendedFrags.${n}.fa"
...
# *use basename*
output_file="${datadir}/blastn_nt_ERR6913147_sample${n}.blast"

#################################################################
# Start work
srun --job-name=blast_sample100_nt blastn -num_threads 12 -db ${nt} -query ${query_fa} -evalue 10 -perc_identity 70 -outfmt 6 -out ${output_file}
#################################################################
